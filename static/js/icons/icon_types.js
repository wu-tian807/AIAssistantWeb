export const model_to_svg = {
    'xai': STATIC_URL + 'icons/models/xai.svg',
    'google': STATIC_URL + 'icons/models/google.svg',
    'deepseek': STATIC_URL + 'icons/models/deepseek.svg',
    'siliconcloud': STATIC_URL + 'icons/models/siliconcloud.svg',
    'oaipro': STATIC_URL + 'icons/models/oaipro.svg'
}
